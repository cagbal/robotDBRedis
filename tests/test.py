...
class UserTest(unittest.TestCase):
    ...
    def test_user_hash(self):
        ...
        self.assertEqual(user0.get_hash(), "user:00001")
        self.assertEqual(user1.get_hash(), "user:00002")
        self.assertEqual(user2.get_hash(), "user:00003")
        self.assertEqual(user3.get_hash(), "user:00004")
        self.assertEqual(user4.get_hash(), "user:00005")
        self.assertEqual(user5.get_hash(), "user:00006")
        self.assertEqual(user6.get_hash(), "user:00007")
